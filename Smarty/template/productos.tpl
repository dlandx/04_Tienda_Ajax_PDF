...
<html lang="en">
    ...
    <body>
        {* Mostra los script necesarios para Ajax *}
        {$getCSS}
        {$getJS}
        {$getScript}
        ...
        <div class="content_product">        
            ...
            <form action="./productos.php" method="POST">
                {* listaProductos.tpl -> Plantilla contenedora para ver los productos BD... *}
                {include file="listaProductos.tpl"}

                {* cesta.tpl -> Plantilla contenedora para ver los productos añadidos a la cesta *}
