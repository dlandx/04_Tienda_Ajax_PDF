                ...
                <section class="cont_btn">
                    ...
                    <div class="fact_btn">
                        ...
                        <form action="https://www.sandbox.paypal.com/cgi-bin/webscr" method="POST">
                            ...
                            {assign var=iva value=0} 
                            {foreach name=pos item=producto from=$datosFactura}                                    
                                <input type="hidden" name="item_name_{$cont}" value="{$producto[0]}">
                                <input type="hidden" name="amount_{$cont}" value="{$producto[2]}">
                                {assign var=iva value=$iva+$producto[2]} {* Sumar los productos *}
                                {assign var=cont value=$cont+1} {* cont++ *}      
                            {/foreach}
                            {* Añadir el IVA *}
                            <input type="hidden" name="item_name_{$cont}" value="IVA">
                            <input type="hidden" name="amount_{$cont}" value="{$iva*0.21}">
